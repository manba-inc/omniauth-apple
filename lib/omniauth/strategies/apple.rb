  ...
  module Strategies
    class Apple < OmniAuth::Strategies::OAuth2
      ...
      def dispatch_cookies
        ...
        Rails.logger.info("#{self.class.name}\##{__method__} request.env["action_dispatch.cookies"] #{request.env["action_dispatch.cookies"]}")

        action_dispatch_cookies = request.cookies
